...
select track_name from track where time < 5;
select * from track where time >= 5;
select artist_name from artist where artist_name < 'M';
select * from track where track_name like 'F_n_%';
select album_name from album where album_name > 'c' and album_name < 'm';
select album_name from album where album_name like 'l%' or album_name like 's%g';
...
select * from album where album_name like 'brotherhood';
select * from track where album_id = 7;

select track_name, time from track where time < 5 limit 3;
select time, track_name from track order by time desc limit 5;
select track_name, artist_id from track where time > 10
or track_name like 'The Perfect Kiss [%' order by track_name desc;